...
\ifcomment
	$ker l≠H$ puisque $\exists \in tq l(x)≠0_h$ On sait que $ker l$ est fermé: soit $(x_n)_n\in|N$ une suite de ker $l$ convergente dans $H$: $x_n\rightarrow x\in H$ mais l est continue: $l(x_n)\rightarrow  l(l(x)$ mais l(x_n)=0 \forall n. $\Rightarrow$  l(x)=0 x\in ker Alors H=ker l \oplus (ker l )^perp (thm projection).
	...
	Soit x\in H t.q. I(x)=O_H' $\Leftrightarrow$ \forall y\in H I(x)(y)=(y|x)=0 $\Rightarrow$  x\perp H $\Rightarrow$  X=0_H \ker I=\{O_h\{ I est injective donc bijective.|)
